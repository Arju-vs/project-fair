        ...
        <div className="card shadow p-2">
          <div className="row align-items-center">
            <div className="col-lg-6">
              <img src={authImg} className='img-fluid' alt="authImage" />
            </div>
            <div className="col-lg-6">
              <h1 className="my-2"><i className='fa-brands fa-docker me-2'></i> Project Fair</h1>
              <h5> {insideRegister? 'Sign Up' : 'Log In'} to your Account</h5>
              <Form>
                {
                  insideRegister &&
              ...
              </FloatingLabel>
              {
                ...
                <div className="mt-3">
                  ...
                  {
                    isLogin && <Spinner animation="border" variant="info" className='ms-2' />
                  }
                  </button>
